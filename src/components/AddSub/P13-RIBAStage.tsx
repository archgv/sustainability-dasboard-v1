...
export const AddRIBAStage = ({ stageNumber, stageData, projectGia, onDataUpdate, onSave, onSaveAndExit, onCancel, currentStep, completedSteps, stageCompletionData }: RibaStageProps) => {
	...
	const renewableTypes = ['Solar', 'Wind', 'Geothermal', 'Biomass', 'Hydro'];

	const energyMethods = ['IES - CIBSE TM54', 'PHPP', 'Other'];
			...
			<div className="flex-1 overflow-y-auto space-y-6 pr-2">
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
					...
					<div className="space-y-4">
						...
						<TooltipField label="Operational energy: Total" tooltip="Enter both regulated and unregulated energy (do not use Part L figures here)">
							<div className="relative">
								<Input
						...
						<TooltipField label="Space heating demand" tooltip="Enter the building's total space heating demand">
							<div className="relative">
								<Input
									placeholder="Enter value (e.g. 35)"
						...
						<TooltipField label="Renewable energy generation" tooltip="Enter the total annual renewable energy generated for the whole building (not per m² GIA)">
							<div className="relative">
								<Input
					...
					<div className="space-y-4">
						...
						<TooltipField label="Total embodied carbon" tooltip="Enter total embodied carbon for life cycle stages A1–C4">
							<div className="relative">
								<Input
						...
						<TooltipField label="Biogenic carbon" tooltip="Enter total biogenic carbon (use a negative number)">
							<div className="relative">
								<Input
