...
import { Filter, Key, X } from "lucide-react";
import { sectorConfig, SectorKeys } from "./Key/KeySector";
import { StageKeys } from "./Key/KeyStage";
import { ProjectTypeKeys } from "./Key/KeyProjectType";
    ...
    <Card className="p-3 rounded-tl-[40px] rounded-tr-[40px] rounded-bl-[66px] rounded-br-[66px] ">
      <Card className="rounded-tl-[80px] rounded-tr-[80px] rounded-bl-[60px] rounded-br-[60px] p-0 shadow-md">
        <Card className="rounded-tl-[60px] rounded-tr-[60px] rounded-bl-[60px] rounded-br-[60px] p-6 pb-4 sticky shadow-inner">
          ...
          <p className="text-pink-200 mt-0 mb-4 text-xs pl-6">
            For project comparison only
          </p>
          ...
          <div className="space-y-4">
            ...
            <div>
              <Label
                htmlFor="typology"
                className="text-sm font-medium text-gray-700 mb-1 block pl-6"
              >
                Sector
              </Label>
              <Select
                value={filters["Primary Sector"]}
            ...
            <div>
              <Label
                htmlFor="projectType"
                className="text-sm font-medium text-gray-700 mb-2 block pl-6"
              >
                Project Type
              </Label>
              <Select
                value={filters["Project Type"] || "all"}
