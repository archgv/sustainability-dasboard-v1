  ...
  return (
    <Card className="flex flex-wrap items-center gap-4 shadow-sm-inner p-2 mb-6">
      ...
      {!["Biodiversity Net Gain", "Urban Greening Factor"].includes(
        ...
        <div className="flex items-center space-x-2">
          <div
            style={{ backgroundColor: chartColors.pink }}
            className="flex rounded-full p-1 bg-slate-100 gap-2"
          >
            <Button
              ...
              style={{
                ...
                backgroundColor:
                  valueType === "average" ? "white" : "transparent",
              }}
            ...
            <Button
              ...
              style={{
                color: chartColors.dark,
                backgroundColor:
                  valueType === "total" ? "white" : "transparent",
              }}
