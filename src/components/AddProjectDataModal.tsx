...
export const AddProjectDataModal = ({ isOpen, onClose, onSave, projects }: AddProjectDataModalProps) => {
  ...
  const handleSave = () => {
    ...
    const project: Project = {
      ...
      'Operational Energy Existing Building': formData['Operational Energy Existing Building'] 
        ? Number(formData['Operational Energy Existing Building']) 
        : undefined,
      ...
      ribaStage: formData.ribaStage as Project['ribaStage'],
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4'>
          ...
          <div className='space-y-4'>
            ...
            <TooltipField label='Project Name & Number'>
              <Popover open={open} onOpenChange={setOpen}>
                <PopoverTrigger asChild>
                  ...
                  >
                    {selectedProjectId
                      ? projects.find(p => p.id === selectedProjectId)?.['Project Name'] || ''
            ...
            <TooltipField label='External Sustainability Consultant' tooltip='Enter Company name of external sustainability consultant if one is appointed?'>
              <Input
                value={formData['External Consultants']}
