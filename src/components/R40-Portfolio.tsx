							...
							<div className="space-y-3 mb-4">
								...
								<div className="text-sm text-gray-600">
									...
									<span className="font-medium">
										Embodied Carbon: {formatNumber(currrentStageProject(project)['Embodied Carbon'])} kgCO<sub>2</sub>e/m²
									</span>
								</div>

								<div className="text-sm text-gray-600">
									{/* <Zap className="h-4 w-4 mr-2 text-blue-600" /> */}
									<span className="font-medium">Operational Energy: {formatNumber(currrentStageProject(project)['Operational Energy'])} kWh/m²/yr</span>
								</div>
