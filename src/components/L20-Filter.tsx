...
export const FilterPanel = ({ filters, onFilterChange, onClearFilters }: FilterProps) => {
	...
	return (
		<Card className="p-3 rounded-tl-[40px] rounded-tr-[40px] rounded-bl-[120px] rounded-br-[120px] ">
			<Card className="rounded-tl-[80px] rounded-tr-[80px] rounded-bl-[120px] rounded-br-[120px] p-0 shadow-md">
				<Card className="rounded-tl-[60px] rounded-tr-[60px] rounded-bl-[120px] rounded-br-[120px] p-6 pb-4 sticky shadow-inner">
