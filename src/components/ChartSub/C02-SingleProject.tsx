...
export const SingleProject = ({
  ...
  const getBenchmark = () => {
    if (!selectedSubSector || valueType !== "average" || projects.length === 0)
      return [];
    ...
    <div className="w-full h-full flex justify-center">
      <ResponsiveContainer {...getResponsiveContainerProps()}>
        <BarChart data={chartData} barGap={-barSize} {...getChartProps()}>
            ...
            content={({ active, payload, label }) => {
              if (active && payload && payload.length) {
                ...
                const renewableKPIOption = KPIOptions.find(
                  (kpi) => kpi.key === "Renewable Energy Generation"
                );
                const renewableShow = [
                  "Operational Energy",
                ...
                const embodiedValue =
                  project["Embodied Carbon Measurement Method"];
                const embodiedShow = [
                  "Upfront Carbon",
                  "Embodied Carbon",
                ].includes(selectedKPI1);
                  ...
                  >
                    ...
                    {renewableShow && (
                      ...
                      >
                        ...
                        {getUnit(renewableKPIOption, valueType)}
                      </p>
                    )}
                    {renewableTypeShow && (
                      <p
                    ...
                    {biogenicShow && (
                      ...
                      >
                        ...
                        {getUnit(biogenicKPIOption, valueType)}
                      </p>
                    )}
                    {structuralShow && (
                      <p
          ...
          {["Operational Energy", "Upfront Carbon", "Embodied Carbon"].includes(
            selectedKPI1
          ) &&
