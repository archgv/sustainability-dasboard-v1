...
export const Comparison = ({
  ...
  const selectedProject = projects.find((p) => p.id === primaryProject);
            ...
            <div className="space-y-2 max-h-64 overflow-y-auto">
              {projects
                ...
                .map((project) => (
                  <div
                    key={project.id}
                    className={`py-3 px-6 shadow-inner rounded-[20px] cursor-pointer transition-colors ${
