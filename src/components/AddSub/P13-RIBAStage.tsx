			...
			<div className="flex-1 overflow-y-auto space-y-6 pr-2">
				...
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
					...
					<div className="space-y-4">
						...
						<TooltipField label="Operational energy" tooltip="Enter both regulated and unregulated energy (do not use Part L figures here)">
							<div className="relative">
								<Input
									placeholder="Enter value (e.g. 65)"
									value={stageData['Operational Energy'] || ''}
									onChange={(e) => handleInputChange('Operational Energy', e.target.value)}
									type="number"
									min="0"
									max="150"
									className="pr-20"
						...
						<TooltipField label="Operational energy: Part L" tooltip="Enter regulated operational energy use (Part L)">
							<div className="relative">
								<Input
						...
						<TooltipField label="Operational energy: Gas" tooltip="Enter gas energy use; enter 0 if no gas is used on site">
							<div className="relative">
								<Input
						...
						<TooltipField label="Space heating demand" tooltip="Enter the building's space heating demand">
							<div className="relative">
								<Input
									placeholder="Enter value (e.g. 35)"
						...
						<TooltipField label="Renewable energy generation" tooltip="Enter the annual renewable energy generated per m² GIA">
							<div className="relative">
								<Input
									placeholder="Enter value (e.g. 5,000)"
									value={stageData['Renewable Energy Generation'] || ''}
									onChange={(e) => handleInputChange('Renewable Energy Generation', e.target.value)}
									type="number"
									min="0"
									className="pr-16"
								/>
					...
					<div className="space-y-4">
						...
						<TooltipField label="Upfront carbon" tooltip="Enter embodied carbon for stages A1–A5">
							<div className="relative">
								<Input
						...
						<TooltipField label="Embodied carbon" tooltip="Enter embodied carbon for life cycle stages A1–C4">
							<div className="relative">
								<Input
									placeholder="Enter value (e.g. 900)"
									value={stageData['Embodied Carbon'] || ''}
									onChange={(e) => handleInputChange('Embodied Carbon', e.target.value)}
									type="number"
									min="0"
									max="1500"
									className="pr-24"
						...
						<TooltipField label="Biogenic carbon" tooltip="Enter biogenic carbon (use a negative number)">
							<div className="relative">
								<Input
						...
						<TooltipField label="Embodied carbon scope clarifications" tooltip="Specify scope, life cycle modules, and whether using RICS V1 or V2 etc.">
							<Textarea
					...
					<div className="space-y-4">
						...
						<TooltipField label="Habitat units gained" tooltip="Enter the number of habitat units gained">
							<Input
						...
						<TooltipField label="Urban greening factor" tooltip="Enter Urban Greening Factor score, if applicable">
							<Input
						...
						<TooltipField label="Additional notes" tooltip="Add any clarifications relating to biodiversity">
							<Textarea
